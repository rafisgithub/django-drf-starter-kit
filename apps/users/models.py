...
class VendorProfile(models.Model):
    ...
    shop_cover_photo = models.ImageField(upload_to='shop_cover_photos/', blank=True, null=True)
    vendor_profile_image = models.ImageField(upload_to='vendor_profile_images/', blank=True, null=True)
